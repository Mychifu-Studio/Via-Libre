...
class ShootingSystem:
    """Logique de tir locale et reseau."""
    ...
    def _spawn_bullet(self, origin, direction, speed=None, life=None, shot_id=None, damage=1):
        ...
        self.game.sound.play("gunshot", (90, 110))
        return bullet
    ...
    def update(self):
        ...
        for bullet in self.bullets:
            ...
            if hasattr(self.game, "enemies"):
                net_iface = getattr(self.game, "network", None)
                is_host = net_iface is None or getattr(net_iface, "net", None) is None or net_iface.net.is_host
                has_hit = self.game.enemies.check_projectile_hit(
                    old_pos,
                    new_pos,
                    self.HIT_RADIUS,
                    apply_damage=is_host,
